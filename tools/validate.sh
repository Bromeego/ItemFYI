...
if [[ -n "$lua_bin" ]]; then
    for file in Core.lua Rules.lua Detection.lua UI.lua tests/test_rules.lua tests/test_detection.lua tests/test_load.lua; do
    ...
    python3 tools/run_lua.py --syntax Core.lua Rules.lua Detection.lua UI.lua tests/test_rules.lua tests/test_detection.lua tests/test_load.lua
